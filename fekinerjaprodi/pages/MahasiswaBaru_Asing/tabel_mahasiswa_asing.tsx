                        ...
                        {tampilMahasiswaAsing.map((tAsing) => {
                          return (
                            <tr key={`tasing` + tAsing.id}>
                              ...
                              <td className="align-middle text-center">
                              <Link href={`/MahasiswaBaru_Asing/edit_mahasiswa_asing/${tAsing.id}`}>
                              <button className="btn btn-sm btn-primary border-0 shadow-sm mb-3 me-3">EDIT</button>
                              </Link>
                             
                              <button onClick={() => deleteMhsAsing(tAsing.id)} className="btn btn-sm btn-danger border-0 shadow-sm mb-3 me-3">HAPUS</button>
